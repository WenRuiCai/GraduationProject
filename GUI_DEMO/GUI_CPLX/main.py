...
from GUI.GUI_CPLX.mwin import Ui_MWin
...
class MWin(QMainWindow, Ui_MWin):
	...
	def detailDone(self, data):
		...
		QMessageBox.information(self, '企业信息查询系统 @CWR', f'{book}\n\n{data}', QMessageBox.Ok)

	def errorHappened(self, msg):
		QMessageBox.warning(self, '企业信息查询系统 @CWR', msg, QMessageBox.Ok)

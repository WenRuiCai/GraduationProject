...
connect = pymysql.Connect(
    host=Spider.src.config.host,
    port=Spider.src.config.port,
    user=Spider.src.config.user,
    passwd=Spider.src.config.passwd,
    db=Spider.src.config.db,
    charset=Spider.src.config.charset,
